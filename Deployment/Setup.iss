...
; Ben Ryves / Bee Development 2007-2025.
[Setup]
AppName=Brass
AppVerName=Brass 3 Beta 16
...
[Files]
; Main executables:
Source: "..\Brass 3\bin\Release\Brass.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: "Brass";
Source: "..\Brass 3\bin\Release\Help.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: "Tools\Help";
Source: "..\Brass 3\bin\Release\Skybound.VisualStyles.dll"; DestDir: "{app}"; Flags: ignoreversion; Components: "Tools\Help";
Source: "..\Brass 3\bin\Release\ProjectBuilder.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: "Tools\ProjectBuilder";
Source: "..\Brass 3\bin\Release\ProjectBuilder.exe.config"; DestDir: "{app}"; Flags: ignoreversion; Components: "Tools\ProjectBuilder";

; Bundled plugins:
Source: "..\Brass 3\bin\Release\Core.dll"; DestDir: "{app}"; Flags: ignoreversion; Components: "Plugins\Core";
Source: "..\Brass 3\bin\Release\Z80.dll"; DestDir: "{app}"; Flags: ignoreversion; Components: "Plugins\Z80";
Source: "..\Brass 3\bin\Release\Chip8.dll"; DestDir: "{app}"; Flags: ignoreversion; Components: "Plugins\Chip8";
Source: "..\Brass 3\bin\Release\TiCalc.dll"; DestDir: "{app}"; Flags: ignoreversion; Components: "Plugins\TiCalc";
Source: "..\Brass 3\bin\Release\Sega.dll"; DestDir: "{app}"; Flags: ignoreversion; Components: "Plugins\Sega";
Source: "..\Brass 3\bin\Release\Scripting.dll"; DestDir: "{app}"; Flags: ignoreversion; Components: "Plugins\Scripting";
Source: "..\Brass 3\bin\Release\Variables.dll"; DestDir: "{app}"; Flags: ignoreversion; Components: "Plugins\Variables";
Source: "..\Brass 3\bin\Release\Legacy.dll"; DestDir: "{app}"; Flags: ignoreversion; Components: "Plugins\Legacy";
Source: "..\Brass 3\bin\Release\ImageManipulation.dll"; DestDir: "{app}"; Flags: ignoreversion; Components: "Plugins\ImageManipulation";


; Bundled debuggers:
Source: "..\Brass 3\bin\Release\PindurTI Debugger.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: "Debuggers\PindurTI";
Source: "..\Brass 3\bin\Release\PindurTI Debugger.exe.config"; DestDir: "{app}"; Flags: ignoreversion; Components: "Debuggers\PindurTI";
Source: "Resources\pindurti.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: "Debuggers\PindurTI";
...
; Developer Notes:
Source: "..\Brass 3\bin\Release\Brass.chm"; DestDir: "{app}\Documentation"; Flags: ignoreversion; Components: "Developer\Reference";
Source: "..\Brass 3\bin\Release\Brass.xml"; DestDir: "{app}"; Flags: ignoreversion; Components: "Developer\XML";
