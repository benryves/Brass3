...
namespace Core {
    ...
    internal class Strings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Page {0:D2} has {1:N0} bytes ({2:P}) free..
        /// </summary>
        internal static string FormatFreePageSpace {
            get {
                return ResourceManager.GetString("FormatFreePageSpace", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to {0:N0} unused bytes of total {1:N0} ({2:P})..
        /// </summary>
        internal static string FormatFreeRomSpace {
            get {
                return ResourceManager.GetString("FormatFreeRomSpace", resourceCulture);
            }
        }
    }
}
