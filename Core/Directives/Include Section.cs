...
namespace Core.Directives {
	...
	public class IncSection : IDirective {
		...
		public void Invoke(Compiler compiler, TokenisedSource source, int index, string directive) {
			...
			if (S == null) throw new CompilerExpection(source, string.Format(Strings.ErrorPluginNotLoaded, "section"));
			...
			if (!S.Sections.TryGetValue(SectionName.ToLowerInvariant(), out SectionRange)) throw new CompilerExpection(source, string.Format(Strings.ErrorSectionNotDefined, SectionName));
